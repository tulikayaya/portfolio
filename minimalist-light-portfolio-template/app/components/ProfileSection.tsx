		...
		<div className="w-full py-8 md:py-0 bg-white px-6 pt-16 sm:pt-0">
			<div className="space-y-8 text-center">
				...
				<div className="space-y-3">
					...
					<h2 className="text-lg md:text-xl text-gray-600">Senior Software Engineer</h2>
				...
				<div className="space-y-4">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<a href="mailto:john.doe@example.com" className="text-sm text-gray-600 hover:text-gray-900">
					...
					<div className="flex items-center justify-center space-x-4 pt-2">
						<a href="https://github.com" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-600 hover:text-gray-900">
						...
						<a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-600 hover:text-gray-900">
							<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
