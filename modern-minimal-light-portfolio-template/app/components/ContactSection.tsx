  ...
  return (
    <section id="contact" className="py-12 md:py-20 px-4 bg-white">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          <a
            href="https://github.com/tulikayaya?tab=repositories"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.linkedin.com/in/tulika-mandal-1ba175307/"
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 bg-gray-100 text-gray-800 rounded-full hover:bg-gray-200 transition-colors"
          >
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black bg-opacity-40 z-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-xl w-full max-w-lg shadow-lg relative">
            ...
            <h3 className="text-2xl font-bold mb-4 text-purple-700">Contact Me</h3>
            <form
              action="https://formsubmit.co/tulikamandal08@gmail.com"
              method="POST"
              className="space-y-4"
            >
              ...
              <button
                type="submit"
                className="w-full py-2 px-6 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors"
              >
                Send Message
              </button>
            </form>
