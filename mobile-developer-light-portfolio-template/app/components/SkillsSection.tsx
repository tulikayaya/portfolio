								...
								<div className="flex flex-wrap sm:flex-nowrap justify-between mb-2 gap-2">
									<div className="flex flex-wrap sm:flex-nowrap items-center gap-2">
										...
										<div className="flex flex-wrap sm:flex-nowrap gap-1">
											...
											{skill.name === 'Swift' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-orange-100 text-orange-600 border border-orange-200">iOS</span>
											)}
											{skill.name === 'Kotlin' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-green-100 text-green-600 border border-green-200">Android</span>
											)}
											{skill.name === 'Flutter' && (
												<span className="px-2 py-0.5 text-xs rounded-full bg-purple-100 text-purple-600 border border-purple-200">Multi-Platform</span>
											)}
										</div>
									</div>
