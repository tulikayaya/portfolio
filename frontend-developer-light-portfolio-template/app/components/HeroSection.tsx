		...
		<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
			...
			<div className="relative z-10 text-center px-4">
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
					<h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">Sarah Parker</h1>
					...
					<div className="flex flex-wrap justify-center gap-4 text-sm">
						...
						<span className="px-4 py-2 bg-blue-100 text-blue-700 rounded-full border border-blue-200">TypeScript</span>
