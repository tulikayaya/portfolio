export default function MobileDevPortfolio() {
	// Sample data - in a real portfolio, this would be customized by the developer
	const apps = [
		{
			id: 1,
			name: 'FitTracker Pro',
	...
	return (
		<main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white overflow-x-hidden">
			{/* Hero Section with Floating Phone */}
				...
				<div className="container mx-auto px-4 relative">
					<div className="max-w-4xl mx-auto">
						<div className="text-center mb-12">
							<h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-8">Let&apos;s Build Something Amazing</h2>
							<p className="text-sm sm:text-base text-gray-400 max-w-2xl mx-auto px-4">
								Looking for a mobile developer who can turn your idea into reality? Let&apos;s connect and discuss your project.
							</p>
						</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
									...
									<div className="space-y-4">
										<div className="flex items-center gap-3">
											...
											<div>
												...
												<a href="mailto:john.doe@example.com" className="text-white hover:text-blue-400 transition-colors">
							...
							{/* Contact Form */}
							<div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
								<h3 className="text-xl font-semibold mb-6 bg-gradient-to-r from-blue-400 to-purple-400 text-transparent bg-clip-text">Send a Message</h3>
								<form className="space-y-4">
									<div>
										...
										<input
											type="text"
											id="name"
											className="w-full bg-gray-900/50 border border-gray-700/50 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 transition-colors"
									...
									<div>
										...
										<textarea
											id="message"
											rows={4}
											className="w-full bg-gray-900/50 border border-gray-700/50 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 transition-colors resize-none"
											placeholder="Tell me about your project..."
										></textarea>
									</div>
									<button
										type="submit"
										className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium px-6 py-3 rounded-lg hover:opacity-90 transition-opacity"
									>
										Send Message
									</button>
								</form>
